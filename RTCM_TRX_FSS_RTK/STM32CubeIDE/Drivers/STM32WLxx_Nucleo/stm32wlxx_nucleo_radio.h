...
/** @defgroup STM32WLXX_NUCLEO_RADIO_LOW_LEVEL_RFSWITCH RADIO LOW LEVEL RF SWITCH Constants
  * @{
  */
#define E77_BOARD  0  // 0:RTK  1:E77
#define UHF_SLOT   0  // 0:on board uhf 1: module uhf
#if(E77_BOARD==1)
...
#else
// for UHF SLOT
#define RF_SW_CTRL1_PIN                          GPIO_PIN_6 //SW
#define RF_SW_CTRL1_GPIO_PORT                    GPIOB
#define RF_SW_CTRL1_GPIO_CLK_ENABLE()            __HAL_RCC_GPIOB_CLK_ENABLE()
#define RF_SW_RX_GPIO_CLK_DISABLE()              __HAL_RCC_GPIOB_CLK_DISABLE()

#define RF_SW_CTRL2_PIN                          GPIO_PIN_7 //EN
#define RF_SW_CTRL2_GPIO_PORT                    GPIOB
#define RF_SW_CTRL2_GPIO_CLK_ENABLE()            __HAL_RCC_GPIOB_CLK_ENABLE()
#define RF_SW_CTRL2_GPIO_CLK_DISABLE()           __HAL_RCC_GPIOB_CLK_DISABLE()

#define RF_SW_CTRL3_PIN                          GPIO_PIN_13 // BYP
